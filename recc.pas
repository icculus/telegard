...
(**                                                                         **)
(**                       ---   R E C C . P A S   ---                       **)
(**                  Current Record Structures Header File                  **)
(**                                                                         **)
...
TYPE
  ...
  fromtoinfo      = V20_fromtoinfo;
  mheaderrec      = V20_mheaderrec;         { *.HDR }
